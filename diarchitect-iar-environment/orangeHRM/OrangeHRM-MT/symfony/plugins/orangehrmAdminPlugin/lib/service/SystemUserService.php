...
class SystemUserService extends BaseService{
    ...
    public function getSystemUserByTenantId($tenantId = null){
        try {
            return $this->getSystemUserDao()->getSystemUserByTenantId( $tenantId );
        } catch (Exception $e) {
            throw new ServiceException($e->getMessage(),$e->getCode(),$e);
        }
    }

    public function setUserTenant($userId, $tenantId){
        try {
            return $this->getSystemUserDao()->setUserTenant($userId, $tenantId);
        } catch (Exception $e) {
            throw new ServiceException($e->getMessage(),$e->getCode(),$e);
        }
    }

    public function deleteUserFromTenant($deleteIds){
        try {
            return $this->getSystemUserDao()->deleteUserFromTenant($deleteIds);
        } catch (Exception $e) {
            throw new ServiceException($e->getMessage(),$e->getCode(),$e);
        }
    }

    public function reactivateSystemUser($userId){
        try {
            return $this->getSystemUserDao()->reactivateSystemUser($userId);
        } catch (Exception $e) {
            throw new ServiceException($e->getMessage(),$e->getCode(),$e);
        }
    }
