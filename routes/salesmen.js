...
const salesmanController = require("../controllers/salesmen");
...
router.get(
  "/@:id/performance-records/:year", // <- careful: make sure your path is correct
  salesmanController.handleGetRecordsByIdByYear
);
router.post("/:id/performance-records", salesmanController.handleCreateRecord);
router.put(
  "/:id/performance-records",
  salesmanController.handleReplaceAllRecords
);
router.delete(
  "/:id/performance-records",
  salesmanController.handleDeleteAllRecords
);
